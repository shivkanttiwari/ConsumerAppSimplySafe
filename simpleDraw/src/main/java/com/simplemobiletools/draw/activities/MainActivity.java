...
public class MainActivity extends SimpleActivity implements MyCanvas.PathsChangedListener {
    ...
    void initializeRef() {
         mMyCanvas = (MyCanvas) findViewById(R.id.my_canvas);
         mUndoBtn = (View) findViewById(R.id.undo);
         mColorPicker = (View) findViewById(R.id.color_picker);
         mStrokeWidthBar = (SeekBar) findViewById(R.id.stroke_width_bar);
    }
    public void undo() {
        mMyCanvas.undo();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.menu_save) {
            ...
            return true;
        } else if (i == R.id.change_background) {
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!fileName.isEmpty()) {
                    ...
                    int i = fileExtensionRG.getCheckedRadioButtonId();
                    if (i == R.id.extension_radio_svg) {
                        extension = ".svg";
